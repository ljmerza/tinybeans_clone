...
- [x] **Settings layout:** Split settings into `mysite/config/settings/{base,local,staging,production,test}.py` with a compatibility shim and documented env vars (`docs/guides/security/env_reference.md`).
