...
class ChildProfileSerializerTests(TestCase):
    ...
    def test_read_only_fields(self):
        ...
        data = {"upgrade_status": "linked", "pending_invite_email": "test@example.com", "linked_user": 1}
...
class ChildProfileUpgradeRequestSerializerTests(TestCase):
    def setUp(self):
        ...
        self.child = ChildProfile.objects.create(circle=self.circle, display_name=f"Test Child {id(self)}")
    ...
    def test_valid_upgrade_request(self):
        ...
        serializer = ChildProfileUpgradeRequestSerializer(data=data, context={"child": self.child})
        self.assertTrue(serializer.is_valid())
    ...
    def test_default_consent_method(self):
        ...
        self.assertEqual(serializer.validated_data["consent_method"], GuardianConsentMethod.DIGITAL_SIGNATURE)

    def test_invalid_email(self):
        """Test validation with invalid email."""
        data = {"email": "invalid-email", "guardian_name": "John Doe", "guardian_relationship": "Father"}
    ...
    def test_already_linked_child(self):
        ...
        data = {"email": "parent@example.com", "guardian_name": "John Doe", "guardian_relationship": "Father"}

        serializer = ChildProfileUpgradeRequestSerializer(data=data, context={"child": linked_child})
        self.assertFalse(serializer.is_valid())
