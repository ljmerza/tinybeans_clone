...
class PetProfileModelTests(TestCase):
    ...
    def test_pet_creation(self):
        ...
        pet = PetProfile.objects.create(
            circle=self.circle, name="Buddy", pet_type=PetType.DOG, breed="Golden Retriever"
        )
    ...
    def test_pet_age_calculation(self):
        ...
        pet = PetProfile.objects.create(circle=self.circle, name="Old Dog", pet_type=PetType.DOG, birthdate=birthdate)
    ...
    def test_pet_without_birthdate(self):
        ...
        pet = PetProfile.objects.create(circle=self.circle, name="Mystery Cat", pet_type=PetType.CAT)
...
class PetProfileViewTests(TestCase):
    ...
    def setUp(self):
        ...
        # Create admin user
        self.admin = User.objects.create_user(email="admin@example.com", password="password123", email_verified=True)
    ...
    def test_list_pets_as_member(self):
        ...
        # Create a pet
        PetProfile.objects.create(circle=self.circle, name="Fluffy", pet_type=PetType.CAT)
    ...
    def test_list_pets_exclude_inactive(self):
        ...
        PetProfile.objects.create(circle=self.circle, name="Active Pet", pet_type=PetType.DOG, is_active=True)
        PetProfile.objects.create(circle=self.circle, name="Inactive Pet", pet_type=PetType.CAT, is_active=False)
    ...
    def test_create_pet_as_admin(self):
        ...
        pet_data = {"name": "Rex", "pet_type": PetType.DOG, "breed": "German Shepherd", "bio": "A loyal companion"}
    ...
    def test_create_pet_as_member_forbidden(self):
        ...
        pet_data = {"name": "Mittens", "pet_type": PetType.CAT}
    ...
    def test_get_pet_details(self):
        ...
        pet = PetProfile.objects.create(circle=self.circle, name="Spot", pet_type=PetType.DOG, breed="Dalmatian")
    ...
    def test_update_pet_as_admin(self):
        ...
        pet = PetProfile.objects.create(circle=self.circle, name="Whiskers", pet_type=PetType.CAT)
    ...
    def test_update_pet_as_member_forbidden(self):
        ...
        pet = PetProfile.objects.create(circle=self.circle, name="Nibbles", pet_type=PetType.RABBIT)
    ...
    def test_delete_pet_as_admin(self):
        ...
        pet = PetProfile.objects.create(circle=self.circle, name="Goldie", pet_type=PetType.FISH)
...
class PetProfileSerializerTests(TestCase):
    ...
    def test_pet_profile_serializer_includes_computed_fields(self):
        ...
        pet = PetProfile.objects.create(
            circle=circle, name="Test Pet", pet_type=PetType.DOG, birthdate=date.today() - timedelta(days=365)
        )
