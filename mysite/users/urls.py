...
urlpatterns = [
    ...
    path(
        "circles/<int:circle_id>/invitations/<uuid:invitation_id>/cancel/",
        CircleInvitationCancelView.as_view(),
        name="circle-invitation-cancel",
    ),
    path(
        "circles/<int:circle_id>/invitations/<uuid:invitation_id>/resend/",
        CircleInvitationResendView.as_view(),
        name="circle-invitation-resend",
    ),
    path("circles/<int:circle_id>/members/", CircleMemberListView.as_view(), name="circle-member-list"),
    path(
        "circles/<int:circle_id>/members/<int:user_id>/", CircleMemberRemoveView.as_view(), name="circle-member-remove"
    ),
    ...
    path(
        "invitations/<uuid:invitation_id>/respond/",
        CircleInvitationRespondView.as_view(),
        name="circle-invitation-respond",
    ),
    path(
        "child-profiles/<uuid:child_id>/upgrade/request/",
        ChildProfileUpgradeRequestView.as_view(),
        name="child-upgrade-request",
    ),
