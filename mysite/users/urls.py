...
urlpatterns = [
    ...
    path('circles/<int:circle_id>/invitations/<uuid:invitation_id>/cancel/', CircleInvitationCancelView.as_view(), name='circle-invitation-cancel'),
    path('circles/<int:circle_id>/invitations/<uuid:invitation_id>/resend/', CircleInvitationResendView.as_view(), name='circle-invitation-resend'),
