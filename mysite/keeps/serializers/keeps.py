...
class KeepCreateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if keep_type == KeepType.MILESTONE and not milestone_data:
            raise serializers.ValidationError({"milestone_data": create_message("errors.milestone_required")})
...
class KeepUpdateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        raise serializers.ValidationError(create_message("errors.keep_update_forbidden"))
