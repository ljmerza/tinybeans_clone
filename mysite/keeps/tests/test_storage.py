...
from mysite.keeps.storage import MediaStorageBackend, MinIOStorageBackend, get_storage_backend
...
class TestMinIOStorageBackend:
    ...
    def test_delete_file(self, mock_minio_class):
        ...
        with override_settings(
            ...
            mock_client.remove_object.assert_called_once_with("test-bucket", "keeps/2024/01/01/test.jpg")
