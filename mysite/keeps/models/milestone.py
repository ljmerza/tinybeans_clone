...
class Milestone(models.Model):
    ...
    milestone_type = models.CharField(max_length=30, choices=MilestoneType.choices, default=MilestoneType.OTHER)
    child_profile = models.ForeignKey(
        "users.ChildProfile", on_delete=models.CASCADE, null=True, blank=True, related_name="milestones"
    )
    age_at_milestone = models.CharField(max_length=50, blank=True, help_text="e.g., '18 months', '2 years 3 months'")
