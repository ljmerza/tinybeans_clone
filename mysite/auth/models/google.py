...
class GoogleOAuthState(models.Model):
    ...
    code_verifier_hash = models.CharField(max_length=128, help_text="SHA-256 hash of PKCE code verifier")
    redirect_uri = models.URLField(help_text="OAuth redirect URI")
    nonce = models.CharField(max_length=64, help_text="Additional CSRF protection nonce")
