    ...
    def post(self, request):
        ...
        try:
            ...
            result = oauth_service.generate_auth_url(
                redirect_uri=redirect_uri, ip_address=ip_address, user_agent=user_agent
            )

            response_serializer = OAuthInitiateResponseSerializer(
                data={"google_oauth_url": result["url"], "state": result["state"], "expires_in": result["expires_in"]}
            )
