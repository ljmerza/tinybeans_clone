    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['token_hash', 'is_used'], name='auth_app_ma_tokenhash_idx'), models.Index(fields=['user', 'expires_at'], name='auth_app_ma_user_id_f5d5d3_idx')],
            },
        ),
        migrations.CreateModel(
            name='TrustedDevice',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user', 'code_hash', 'is_used'], name='auth_app_tw_user_id_f20d7f_idx'), models.Index(fields=['expires_at'], name='auth_app_tw_expires_379caf_idx')],
            },
        ),
    ]
