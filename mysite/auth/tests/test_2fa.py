...
from mysite.auth.models import RecoveryCode, TwoFactorCode, TwoFactorSettings
...
class TestTwoFactorStatusView:
    ...
    def test_status_configured(self):
        ...
        user = create_user()
        settings_obj = TwoFactorSettings.objects.create(user=user, is_enabled=True, preferred_method="totp")
...
class TestRecoveryCodeGeneration:
    ...
    def test_generate_recovery_codes(self):
        ...
        user = create_user()
        TwoFactorSettings.objects.create(user=user, is_enabled=True, preferred_method="totp")
