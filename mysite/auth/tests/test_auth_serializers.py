...
class PasswordChangeSerializerTests(TestCase):
    ...
    def test_valid_password_change(self):
        ...
        data = {"current_password": "oldpassword", "password": "newpassword123", "password_confirm": "newpassword123"}
    ...
    def test_short_new_password(self):
        ...
        data = {"current_password": "oldpassword", "password": "short", "password_confirm": "short"}
    ...
    def test_wrong_current_password(self):
        ...
        data = {"current_password": "wrongpassword", "password": "newpassword123", "password_confirm": "newpassword123"}
