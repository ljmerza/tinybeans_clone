...
from mysite.auth.models import GoogleOAuthState, TwoFactorCode
...
def create_oauth_state(redirect_uri="http://localhost:3000/auth/google/callback", ip_address="192.168.1.1", **kwargs):
