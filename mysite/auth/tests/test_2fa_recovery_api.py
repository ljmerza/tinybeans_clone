...
class TestRecoveryCodeAPI:
    ...
    def test_generate_recovery_codes_not_enabled(self):
        ...
        TwoFactorSettings.objects.create(user=self.user, is_enabled=False)
    ...
    def test_download_recovery_codes_pdf(self, mock_pdf):
        ...
        response = self.client.post(
            "/api/auth/2fa/recovery-codes/download/", {"format": "pdf", "codes": codes}, content_type="application/json"
        )
    ...
    def test_download_no_codes(self):
        ...
        response = self.client.post(
            "/api/auth/2fa/recovery-codes/download/", {"format": "txt", "codes": []}, content_type="application/json"
        )
