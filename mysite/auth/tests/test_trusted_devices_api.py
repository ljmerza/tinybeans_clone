...
class TestTrustedDevicesAPI:
    ...
    def test_remove_trusted_device_success(self, mock_remove):
        ...
        response = self.client.delete("/api/auth/2fa/trusted-devices/", {"device_id": "test-device-123"})
    ...
    def test_remove_trusted_device_not_found(self, mock_remove):
        ...
        response = self.client.delete("/api/auth/2fa/trusted-devices/", {"device_id": "non-existent"})
