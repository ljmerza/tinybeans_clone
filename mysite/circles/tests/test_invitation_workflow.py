...
class InvitationWorkflowTests(TestCase):
    ...
    def test_new_user_onboarding_flow(self, mock_delay):
        ...
        response = self.client.post(reverse("circle-invitation-accept"), {"token": invite_token}, format="json")
        ...
        finalize = self.client.post(
            reverse("circle-invitation-finalize"), {"onboarding_token": onboarding_token}, format="json"
        )
