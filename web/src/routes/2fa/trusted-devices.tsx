...
import { useTrustedDevices, useRemoveTrustedDevice } from '@/modules/twofa/hooks'
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-sm">
              These devices can skip 2FA verification for 30 days. Remove a device to require 2FA
              on next login.
            </p>
          </div>
          ...
          {devices.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-500">
                Enable "Remember this device" during 2FA verification to add trusted devices
              </p>
            </div>
          ) : (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="space-y-1 text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span>{new Date(device.last_used_at).toLocaleString()}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="font-medium">Expires:</span>
                          <span>{new Date(device.expires_at).toLocaleDateString()}</span>
                        </div>
                        <div className="flex items-center gap-2">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleRemove(device.device_id, device.device_name)}
