...
function TwoFactorSetupPage() {
  ...
  const [selectedMethod, setSelectedMethod] = useState<'totp' | 'email' | 'sms' | null>(null)
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-6">
          {!selectedMethod ? (
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-2">
                        Use Google Authenticator, Authy, 1Password, or similar apps to generate
                        verification codes
                      </p>
            ...
            <div>
              {selectedMethod === 'totp' && (
                <TotpSetup onComplete={handleComplete} onCancel={handleCancel} />
              )}
              {selectedMethod === 'email' && (
                <div className="text-center py-8">
                  <p className="text-gray-600">Email 2FA setup coming soon...</p>
