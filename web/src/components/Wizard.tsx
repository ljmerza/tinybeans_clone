...
export function WizardStep<TStep extends string>({ children }: WizardStepProps<TStep>) {
    return <>{children}</>;
}
...
export function Wizard<TStep extends string>({ currentStep, children, className }: WizardProps<TStep>) {
...
export function WizardSection({ title, description, children }: WizardSectionProps) {
    return (
        <>
