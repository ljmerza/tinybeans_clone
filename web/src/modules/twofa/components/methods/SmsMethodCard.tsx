        ...
        <Card className="border-2 border-gray-200">
            <CardHeader className="flex items-start gap-4 pb-0">
                ...
                <div className="flex-1 space-y-2">
                    ...
                    <CardDescription>Receive verification codes via text message.</CardDescription>
                    <ChipGroup className="mb-1">
                        <Chip variant="primary">Quick</Chip>
                        <Chip className="bg-orange-100 text-orange-800">Requires Phone Number</Chip>
                    </ChipGroup>
                    {isCurrent && (
            ...
            <CardContent className="pt-4">
                <ButtonGroup>
                    {configured ? (
                        ...
                        >
                            {removalInProgress && methodToRemove === "sms" ? "Removing..." : "Remove"}
                        </Button>
                    ) : (
